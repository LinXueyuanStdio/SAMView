...
//import com.same.lib.theme.PatternsLoader;
...
//            if (optionsDrawable == null || themeInfo == null || themeInfo.info != null && !themeInfo.themeLoaded || currentType != ThemePage.THEME_TYPE_BASIC) {
...
//                                themeInfo.pathToWallpaper = new File(AndroidUtilities.getFilesDirFixed(), AndroidUtilities.MD5(wallpaperLink) + ".wp").getAbsolutePath();
//
...
//            ThemeInfo t = currentType == ThemePage.THEME_TYPE_NIGHT ? ThemeManager.getCurrentNightTheme() : ThemeManager.getCurrentTheme();
...
//
//            String name = themeInfo.getName(getContext());
...
//
//                if (optionsDrawable != null && currentType == ThemePage.THEME_TYPE_BASIC) {
...
//        currentType = type;
//
//        if (type == ThemePage.THEME_TYPE_OTHER) {
...
//        }
//        if (currentType != ThemePage.THEME_TYPE_OTHER) {
//            SharedPreferences.Editor editor = AndroidUtilities.getThemeConfig().edit();
//            editor.putString(currentType == ThemePage.THEME_TYPE_NIGHT || themeInfo.isDark() ? "lastDarkTheme" : "lastDayTheme", themeInfo.getKey());
//            editor.commit();
//        }
//        if (currentType == ThemePage.THEME_TYPE_NIGHT) {
...
//                return;
//            }
//            NotificationCenter.postNotificationName(NotificationCenter.needSetDayNightTheme, themeInfo);
//        }
//        updateRows();
//
...
//        super.onDraw(canvas);
//        if (drawDivider) {
//            canvas.drawLine(isRTL ? 0 : AndroidUtilities.dp(20), getMeasuredHeight() - 1, getMeasuredWidth() - (isRTL ? AndroidUtilities.dp(20) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
//        }
//    }
//
...
//            ThemeInfo info = loadingThemes.get(fileName);
//            if (info != null) {
...
//            return;
//        }
//        prevThemeInfo = currentType == ThemePage.THEME_TYPE_NIGHT ? ThemeManager.getCurrentNightTheme() : ThemeManager.getCurrentTheme();
