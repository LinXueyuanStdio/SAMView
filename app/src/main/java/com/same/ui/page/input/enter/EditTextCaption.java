...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public void makeSelectedUrl() {
        ...
        builder.setTitle(MyLang.getString("CreateLink", R.string.CreateLink));
...
//        editText.setTextColor(Theme.getColor(Theme.key_dialogTextBlack));TODO
        editText.setHintText(MyLang.getString("URL", R.string.URL));
//        editText.setHeaderHintColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader));TODO
...
//        editText.setLineColors(Theme.getColor(Theme.key_windowBackgroundWhiteInputField), Theme.getColor(Theme.key_windowBackgroundWhiteInputFieldActivated), Theme.getColor(Theme.key_windowBackgroundWhiteRedText3));
        ...
        builder.setPositiveButton(MyLang.getString("OK", R.string.OK), (dialogInterface, i) -> {
    ...
    private void applyTextStyleToSelection(TextStyleSpan span) {
        ...
        MediaController.addStyleToText(span, start, end, getText(), allowTextEntitiesIntersection);
        if (delegate != null) {
            delegate.onSpansChanged();
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (hasSelection()) {
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_bold, MyLang.getString("Bold", R.string.Bold)));
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_italic, MyLang.getString("Italic", R.string.Italic)));
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_mono, MyLang.getString("Mono", R.string.Mono)));
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_strike, MyLang.getString("Strike", R.string.Strike)));
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_underline, MyLang.getString("Underline", R.string.Underline)));
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_link, MyLang.getString("CreateLink", R.string.CreateLink)));
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_regular, MyLang.getString("Regular", R.string.Regular)));
        }
    }
