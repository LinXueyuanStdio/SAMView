...
public class TextStyleSpan extends MetricAffectingSpan {
    ...
    public static class TextStyleRun {
        ...
        public Typeface getTypeface() {
            if ((flags & FLAG_STYLE_MONO) != 0 || (flags & FLAG_STYLE_QUOTE) != 0) {
                ...
                return FontManager.getTypeface(MyApplication.applicationContext, "fonts/rmediumitalic.ttf");
            } else if ((flags & FLAG_STYLE_BOLD) != 0) {
                return FontManager.getTypeface(MyApplication.applicationContext, "fonts/rmedium.ttf");
            } else if ((flags & FLAG_STYLE_ITALIC) != 0) {
                return FontManager.getTypeface(MyApplication.applicationContext, "fonts/ritalic.ttf");
            } else {
                return null;
            }
        }
    ...
    public boolean isBold() {
        return style.getTypeface() == FontManager.getTypeface(MyApplication.applicationContext, "fonts/rmedium.ttf");
    }

    public boolean isItalic() {
        return style.getTypeface() == FontManager.getTypeface(MyApplication.applicationContext, "fonts/ritalic.ttf");
    }

    public boolean isBoldItalic() {
        return style.getTypeface() == FontManager.getTypeface(MyApplication.applicationContext, "fonts/rmediumitalic.ttf");
    }
