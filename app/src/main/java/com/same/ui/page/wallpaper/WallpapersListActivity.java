...
//import com.same.ui.page.theme.WallpaperUpdater;
//import com.same.ui.view.EmptyTextProgressView;
//import com.same.ui.view.NumberTextView;
...
// * @usage null
// */
//public class WallpapersListActivity extends BasePage {
//
...
//                }
//            }
//            String linkPrefix = "t.me";
//            if (pattern != null) {
//                String link = "https://" + linkPrefix + "/bg/" + pattern.slug + "?intensity=" + (int) (intensity * 100) + "&bg_color=" + color1;
//                if (motion) {
//                    link += "&mode=motion";
//                }
//                return link;
//            } else {
//                return "https://" + linkPrefix + "/bg/" + color1;
//            }
//        }
//    }
//
...
//        if (currentType == TYPE_ALL) {
//            actionBar.setTitle(MyLang.getString("ChatBackground", R.string.ChatBackground));
//        } else if (currentType == TYPE_COLOR) {
//            actionBar.setTitle(MyLang.getString("SelectColorTitle", R.string.SelectColorTitle));
//        }
...
//                    builder.setTitle(MyLang.formatPluralString("DeleteBackground", selectedWallPapers.size()));
//                    builder.setMessage(MyLang.formatString("DeleteChatBackgroundsAlert", R.string.DeleteChatBackgroundsAlert));
...
//                }
//            });
//            searchItem.setSearchFieldHint(MyLang.getString("SearchBackgrounds", R.string.SearchBackgrounds));
//
...
//                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
//                builder.setTitle(MyLang.getString("ResetChatBackgroundsAlertTitle", R.string.ResetChatBackgroundsAlertTitle));
//                builder.setMessage(MyLang.getString("ResetChatBackgroundsAlert", R.string.ResetChatBackgroundsAlert));
//                builder.setPositiveButton(MyLang.getString("Reset", R.string.Reset), (dialogInterface, i) -> {
//                    if (actionBar.isActionModeShowed()) {
//                        selectedWallPapers.clear();
//                        actionBar.hideActionMode();
//                        updateRowsSelection();
...
//        searchEmptyView.setText(MyLang.getString("NoResult", R.string.NoResult));
...
//                        String color = MyLang.getString("BackgroundSearchColor", R.string.BackgroundSearchColor);
//                        Spannable spannable = new SpannableString(color + " " + MyLang.getString(searchColorsNames[position], searchColorsNamesR[position]));
...
//                    cell.setText(MyLang.getString("SearchByColor", R.string.SearchByColor));
//                    break;
//                }
//            }
//        }
...
//                    if (position == uploadImageRow) {
//                        textCell.setTextAndIcon(MyLang.getString("SelectFromGallery", R.string.SelectFromGallery), R.drawable.profile_photos, true);
//                    } else if (position == setColorRow) {
//                        textCell.setTextAndIcon(MyLang.getString("SetColor", R.string.SetColor), R.drawable.menu_palette, false);
//                    } else if (position == resetRow) {
//                        textCell.setText(MyLang.getString("ResetChatBackgrounds", R.string.ResetChatBackgrounds), false);
//                    }
//                    break;
//                }
//                case 3: {
...
//                        cell.setText(MyLang.getString("ResetChatBackgroundsInfo", R.string.ResetChatBackgroundsInfo));
//                    }
//                    break;
//                }
//                case 2: {
...
//                        if (object instanceof WallPaper) {
//                            WallPaper wallPaper = (WallPaper) object;
//                            OverrideWallpaperInfo info = ThemeManager.getActiveTheme().overrideWallpaper;
