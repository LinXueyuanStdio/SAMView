...
public class SizeNotifierFrameLayout extends FrameLayout {
    ...
    private ThemeContainerLayout parentLayout;
    ...
    public SizeNotifierFrameLayout(Context context, ThemeContainerLayout layout) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Drawable newDrawable = null;//TODO 背景，壁纸
