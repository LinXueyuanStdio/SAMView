...
public final class Bulletin {
    ...
    public static Bulletin make(@NonNull BasePage fragment, @NonNull Layout contentLayout, int duration) {
    ...
    private static ContainerLayout findActionBarLayout(View view) {
        while (view != null) {
