...
import com.same.lib.listview.RecyclerView.OnItemTouchListener;
import com.same.lib.listview.RecyclerView.ViewHolder;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView != null) {
            ...
            mSwipeEscapeVelocity = dp(density, 120);
            mMaxSwipeVelocity = dp(density, 800);
            setupCallbacks();
        }
    }
    public int dp(float density, float value) {
        if (value == 0) {
            return 0;
        }
    ...
    public abstract static class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                ...
                mCachedMaxScrollSpeed = dp(recyclerView.getResources().getDisplayMetrics().density, 20);
            }
